<div class="card">
    ...
    <div class="card-body floating-label">
        <div class="form-group<?php echo e($errors->has('car_id') ? ' has-error' : ''); ?>">
            <?php echo e(Form::select('car_id', isset($auction)?[$auction->car->id=>$auction->car->title]:[], null,['class' => 'js-data-example-ajax form-control', 'placeholder' => 'Select Car'])); ?>
        ...
        <div class="form-group<?php echo e($errors->has('bid_starting_amount') ? ' has-error' : ''); ?>">
            <?php echo e(Form::number('bid_starting_amount', null ,['min' => 0, 'class' => 'form-control'])); ?>

            <?php echo e(Form::label('bid_starting_amount', 'Starting Amount:')); ?>

            <?php if($errors->has('bid_starting_amount')): ?>
                <span class="help-block">
                    <strong><?php echo e($errors->first('bid_starting_amount')); ?></strong>
                </span>
            <?php endif; ?>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group<?php echo e($errors->has('start_date') ? ' has-error' : ''); ?>">
                    <?php echo e(Form::text('start_date', isset($auction)? date('d F Y', strtotime($auction->start_date)).' -- '. $auction->start_time :null ,['class' => 'form-control'])); ?>
            ...
            <div class="col-sm-6">
                <div class="form-group<?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
                    <?php echo e(Form::text('end_date', isset($auction)? date('d F Y', strtotime($auction->end_date)).' -- '. $auction->end_time :null ,['class' => 'form-control'])); ?>
