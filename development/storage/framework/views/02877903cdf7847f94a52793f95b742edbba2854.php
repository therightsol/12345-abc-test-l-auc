    ...
    <div class="card-body form-horizontal">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="form-group<?php echo e($errors->has('max_allowed_bits') ? ' has-error' : ''); ?>">
                    <?php echo e(Form::label('max_allowed_bits', 'Max Allowed Bids:', ['class' => 'control-label col-sm-4'])); ?>

                    <div class="col-sm-8">
                        <?php echo e(Form::text('max_allowed_bits', isset($settings['max_allowed_bits'])? $settings['max_allowed_bits']: null,['class' => 'form-control'])); ?>

                    <?php if($errors->has('max_allowed_bits')): ?>
                            <span class="help-block">
                    <strong><?php echo e($errors->first('max_allowed_bits')); ?></strong>
                </span>
                        <?php endif; ?>
                    </div>
                </div>
