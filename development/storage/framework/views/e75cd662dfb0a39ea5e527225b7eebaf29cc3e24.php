            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    ...
                    <div class="card-body style-default-bright">
                        ...
                        <form class="form floating-label" action="<?php echo e(route('do-login')); ?>" accept-charset="utf-8" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block"><a href="<?php echo e(route('reset-password')); ?>">Forgotten?</a></p>
                            </div>
                            <br>
