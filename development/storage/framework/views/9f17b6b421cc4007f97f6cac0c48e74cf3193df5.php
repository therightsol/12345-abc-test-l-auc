                    ...
                    <ul class="dropdown-menu animation-expand">
                        ...
                        <li>
                            <a class="alert alert-callout alert-warning" href="javascript:void(0);">
                                <img class="pull-right img-circle dropdown-avatar" src="<?php echo e(Module::asset('commonbackend:admin_assets/img/avatar2.jpg?1404026449')); ?>" alt="" />
                        ...
                        <li>
                            <a class="alert alert-callout alert-info" href="javascript:void(0);">
                                <img class="pull-right img-circle dropdown-avatar" src="<?php echo e(Module::asset('commonbackend:admin_assets/img/avatar3.jpg?1404026799')); ?>" alt="" />
            ...
            <ul class="header-nav header-nav-profile">
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
                        <img src="<?php echo e(Module::asset('commonbackend:admin_assets/img/avatar1.jpg?1403934956')); ?>" alt="" />
